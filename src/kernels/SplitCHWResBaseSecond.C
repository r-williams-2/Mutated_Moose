...
validParams<SplitCHWResBaseSecond<>>()
{
  ...
  params.addRequiredCoupledVar ("c_i", "Concentration of species for diffusion coefficient.");
  params.addRequiredCoupledVar ("c_j", "Concentration of species for diffusion potential.");
  return params;
}
